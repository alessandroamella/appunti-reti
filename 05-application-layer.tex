...
\onehalfspacing % Aumenta spaziatura tra righe per leggibilità

% --- Font sans-serif con dimensione aumentata ---
\usepackage[scaled=1.1]{helvet} % Dimensione font aumentata
\renewcommand{\familydefault}{\sfdefault}
\usepackage[T1]{fontenc}

% --- Aumenta dimensione di default del testo ---
\usepackage{anyfontsize}
\fontsize{12pt}{14pt}\selectfont % Aumenta dimensione di default del testo
...
\usepackage{enumitem}
\setlist{itemsep=4pt} % Aumenta spaziatura tra elementi delle liste

% --- Immagini e Disegni ---
\usepackage{float}
\usepackage{graphicx}
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, positioning, arrows.meta, fit, calc, decorations.pathreplacing, patterns}
...
\usepackage{xcolor}
\definecolor{darkergray}{rgb}{0.08,0.08,0.08} % Sfondo leggermente più scuro per contrasto
\definecolor{lighttext}{rgb}{0.98,0.98,0.98} % Testo leggermente più chiaro per contrasto
...
\setminted{
    frame=lines,
    framesep=2mm,
    fontsize=\normalsize, % Dimensione aumentata
    breaklines=true,
    style=monokai, % Stile che si adatta bene a sfondi scuri
    bgcolor=black % Sfondo specifico per i blocchi minted
}
\newminted{text}{frame=lines, framesep=2mm, fontsize=\normalsize, breaklines=true, style=monokai, bgcolor=black}
\newminted{python}{frame=lines, framesep=2mm, fontsize=\normalsize, breaklines=true, style=monokai, bgcolor=black}
