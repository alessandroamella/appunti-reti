...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[node distance=1.2cm and 1.5cm, auto]
        ...
        % Keys
        \node (keyA) [key, above=0.3cm of enc_algo, label=left:Alice's Key] {$K_A$};
        \node (keyB) [key, above=0.3cm of dec_algo, label=right:Bob's Key] {$K_B$};
        
        % Trudy
        \node (trudy_crypto) [intruder, below=of dec_algo] {Trudy};
