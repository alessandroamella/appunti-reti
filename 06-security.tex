...
\usepackage{amsmath}
\usepackage{amssymb}
\usepackage{amsfonts} % Aggiunto per simboli matematici
...
\usetikzlibrary{shapes.geometric, positioning, arrows.meta, calc, fit} % Aggiornato per frecce e positioning
...
\setminted{
    ...
    bgcolor=gray!10 % Sfondo leggermente diverso per i blocchi minted
}
